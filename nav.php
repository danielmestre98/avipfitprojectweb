...
<html>
    ...
    <div class="page-wrapper chiller-theme bg1">
		<div id="show-sidebar" style="position: fixed; z-index: 50"><span title="Expandir menu" class="btn btn-dark fixed-btn" style="border-bottom-left-radius: 0; border-top-left-radius: 0; margin-top: 10px;"><i class="fas fa-bars"></i></span></div>
		
        <nav id="sidebar" class="sidebar-wrapper">
            <div class="sidebar-content">
                <!-- sidebar-brand  -->
                <div class="sidebar-item sidebar-brand">
                    <a title="Página inicial" href="index">avipfit</a>
