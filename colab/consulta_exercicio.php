	...
	<script>
		$( document ).ready( function () {
			...
			$( '#tabela' ).DataTable( {
				...
				"autoWidth": false,
				"bProcessing": true,
				"sAjaxSource": "../lib/consulta_exercicio.php",
				"columns": [ {
					data: 'NomeExercicio'
				}, {
					data: null,
					render: function ( data, type, row ) {
						return '<a title="Editar" href="editar_exercicio.php?nome=' + data.id + '"><i class="fas fa-edit"></i></a>  <a title="Excluir" onclick ="confirma(\'' + data.NomeExercicio + '\',\'' + data.id + '\')" href="#"><i class="far fa-trash-alt"></i></a>'
